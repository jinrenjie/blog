...
comments: true
thumbnail: /cover/let-s_encrypt-3.jpg
tags:
- HTTPS
- Let's Encrypt
- ACME.sh
...
- [技术, HTTPS]
---
Let's Encrypt 终于在社区宣布支持通配子域名的证书免费申请了。对于需要多个子域名证书的个人来说简直就是福音，因为 Let’s Encrypt 是一个 CA 机构，但这个 CA 机构是免费的！也就是说签发证书不需要任何费用。
<!-- more -->
