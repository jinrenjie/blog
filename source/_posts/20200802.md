...
toc: true
comments: true
thumbnail: /cover/20200802-gitlab-runner-deploy-vue.jpg
tags:
  - Vue
  - CI
  - CD
...
![Project > Settings > CI/CD > Variables](/images/article/20200802-gitlab-project-env-variables.png)

还有就是需要注意项目是否有可用的 Runner， 同样的也是访问： Project > Settings > CI/CD > Runners，查看指定 tag 的 Runner 是否可用。

![Project > Settings > CI/CD > Runners](/images/article/20200802-gitlab-project-runners.png)
...
![当 PUSH 到 master 分支时的 Pipelines 中的 Jobs](/images/article/20200802-gitlab-project-master-pipelines.png)

当我们为项目打了 v1.0.1 的 tag 后并发布了 release，则此时的 Pipeline 的 Jobs 如下：

![打了 tag 后的 Jobs](/images/article/20200802-gitlab-project-release-pipelines.png)
