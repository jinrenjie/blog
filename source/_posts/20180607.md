...
toc: true
comments: true
thumbnail: /cover/20180607-ssh-key-login.jpg
tags:
  - ssh
  - key
  - rsa
...
---
之前一直使用用户名和密码的方式登录 Linux 服务器的，但是最近发现 Linux 有很多登录失败的日志，很多 IP 尝试暴力破解用户密码，出于安全考虑，我决定禁用密码登录，采用 SSH RSA Key 的方式来登录。
<!-- more -->
