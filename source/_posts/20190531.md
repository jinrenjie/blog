...
访问项目`设置` > `CI/CD` 展开 Runners 项的配置，查看是否有可用 Runner 如果有，则记录下 Tag，如果没有则参考我的文章[《DevOps 之注册 Gitlab Runner》](https://george.betterde.com/technology/DevOps/20190525/) 进行注册。
