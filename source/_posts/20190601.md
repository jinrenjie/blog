...
toc: true
comments: true
thumbnail: /cover/consul-service-configuration.png
tags:
  - Consul
  - Configuration
  - Service Mesh
...
之前我写过一片[《管理服务配置》](https://george.betterde.com/technology/20190215/)，在这篇文章中，主要讲解了 Consul 搭配 confd 实现服务配置的自动更新。那么在这里就不再过多赘述如何搭建 Consul 的服务了。
...
这样就完成了 Consul Tempalate 的进程管理了。
