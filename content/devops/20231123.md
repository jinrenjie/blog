...
今天分享的就是我自己摸索出来的一些经验，总结出来的最佳实践，通过 Gitlab 的强大生态，让 Go 项目从开发到部署都变得更加高效！
...
* CI_REGISTRY_PASSWORD: 等同于预设环境变量 `$CI_JOB_TOKEN`
...
如果你使用 Personal Token 作为 CI/CD 中的身份认证的话，那么需要要这个 Personal Token 的所有者拥有私有包的仓库访问权限。
